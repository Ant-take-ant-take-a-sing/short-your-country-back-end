...
Hosting news images via Supabase Storage
Providing off-chain data for oracle consumption
Supporting viem & wagmi-based on-chain integration

🧠 Web3 Use Case

📈 Long a country when positive news dominates
📉 Short a country during negative geopolitical or economic events


✨ Features

Country-based news feed
